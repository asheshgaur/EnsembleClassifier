...
//---CutTSS---Construction---
        ...
        printf("BENCHMARK.CutTSS.CONSTRUCTION_MS=%f\n", elapsed_milliseconds.count());
        printf("BENCHMARK.CutTSS.MEMORY_BYTES=%llu\n", static_cast<unsigned long long>(CT.MemSizeBytes()));
...
//---PSTSS---Construction---		
        ...
        printf("BENCHMARK.PSTSS.CONSTRUCTION_MS=%f\n", elapsed_milliseconds.count());
        printf("BENCHMARK.PSTSS.MEMORY_BYTES=%llu\n", static_cast<unsigned long long>(PSTSS.MemSizeBytes()));
...
//---PartitionSort---Construction---
        ...
        printf("BENCHMARK.PartitionSort.CONSTRUCTION_MS=%f\n", elapsed_milliseconds.count());
        printf("BENCHMARK.PartitionSort.MEMORY_BYTES=%llu\n", static_cast<unsigned long long>(PS.MemSizeBytes()));
...
//---CutSplit---Construction---
        ...
        printf("BENCHMARK.CutSplit.CONSTRUCTION_MS=%f\n", elapsed_milliseconds.count());
        printf("BENCHMARK.CutSplit.MEMORY_BYTES=%llu\n", static_cast<unsigned long long>(CS.MemSizeBytes()));
...
//---CutTSS---Classification---			
            ...
            printf("BENCHMARK.CutTSS.TIME_NS_TOTAL=%.0f\n", (sum_timeCS.count() / trials) * 1e9);
            printf("BENCHMARK.CutTSS.ACCURACY_PERCENT=%f\n",
                   100.0 * (number_pkt * trials - match_miss) / double(number_pkt * trials));
            printf("BENCHMARK.CutTSS.CORRECT=%d\n", number_pkt * trials - match_miss);
            printf("BENCHMARK.CutTSS.INCORRECT=%d\n", match_miss);
            printf("BENCHMARK.CutTSS.PACKETS=%d\n", number_pkt * trials);
...
//                    matchid[j] = pri_id[PSTSS.ClassifyAPacket(packets[j])];
            ...
            printf("BENCHMARK.PSTSS.TIME_NS_TOTAL=%.0f\n", (sum_time1.count() / trials) * 1e9);
            printf("BENCHMARK.PSTSS.ACCURACY_PERCENT=%f\n",
                   100.0 * (number_pkt * trials - match_miss) / double(number_pkt * trials));
            printf("BENCHMARK.PSTSS.CORRECT=%d\n", number_pkt * trials - match_miss);
            printf("BENCHMARK.PSTSS.INCORRECT=%d\n", match_miss);
            printf("BENCHMARK.PSTSS.PACKETS=%d\n", number_pkt * trials);
...
//                    matchid[j] = pri_id[ps.ClassifyAPacket(packets[j])];
            ...
            printf("BENCHMARK.PartitionSort.TIME_NS_TOTAL=%.0f\n", (sum_time2.count() / trials) * 1e9);
            printf("BENCHMARK.PartitionSort.ACCURACY_PERCENT=%f\n",
                   100.0 * (number_pkt * trials - match_miss) / double(number_pkt * trials));
            printf("BENCHMARK.PartitionSort.CORRECT=%d\n", number_pkt * trials - match_miss);
            printf("BENCHMARK.PartitionSort.INCORRECT=%d\n", match_miss);
            printf("BENCHMARK.PartitionSort.PACKETS=%d\n", number_pkt * trials);
...
//                    results.push_back(pri_id[CS.ClassifyAPacket(p)]);
            ...
            printf("\tAverage classification time: %f us\n",
                   sum_timecs.count() * 1e6 / double(trials * packets.size()));
            printf("\tThroughput: %f Mpps\n", 1 / (sum_timecs.count() * 1e6 / double(trials * packets.size())));
            printf("BENCHMARK.CutSplit.TIME_NS_TOTAL=%.0f\n", (sum_timecs.count() / trials) * 1e9);
            printf("BENCHMARK.CutSplit.ACCURACY_PERCENT=%f\n",
                   100.0 * (number_pkt * trials - match_miss) / double(number_pkt * trials));
            printf("BENCHMARK.CutSplit.CORRECT=%d\n", number_pkt * trials - match_miss);
            printf("BENCHMARK.CutSplit.INCORRECT=%d\n", match_miss);
            printf("BENCHMARK.CutSplit.PACKETS=%d\n", number_pkt * trials);
        }
